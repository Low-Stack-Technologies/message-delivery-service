...
func (siw *ServerInterfaceWrapper) DeleteAdminService(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "serviceId", runtime.ParamLocationPath, chi.URLParam(r, "serviceId"), &serviceId)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "serviceId", Err: err})
		return
	}
...
func (siw *ServerInterfaceWrapper) PostV3Email(w http.ResponseWriter, r *http.Request) {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Client-Id")]; found {
		...
		err = runtime.BindStyledParameterWithLocation("simple", false, "X-Client-Id", runtime.ParamLocationHeader, valueList[0], &XClientId)
		if err != nil {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-Timestamp")]; found {
		...
		err = runtime.BindStyledParameterWithLocation("simple", false, "X-Timestamp", runtime.ParamLocationHeader, valueList[0], &XTimestamp)
		if err != nil {
